...
We get all this information from our backend.
...
** Just for the sake of blog post, we are making it public. In general you would not want to do  that.**

### Accessing Google Cloud
import the required dependencies as follows:
