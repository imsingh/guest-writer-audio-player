...
Also, calling `Observable.create` will return an `Observable` to which you can subscribe via `subscribe` method. This `subscribe` method returns a function that you can call when you want to unsubscribe from the observable.
